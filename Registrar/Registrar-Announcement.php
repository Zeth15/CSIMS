    ...
    <div class="d-flex" id="wrapper">
        <div class="offcanvas offcanvas-start" id="demo" style="width: 180px">
            <div class="offcanvas-body">
                ...
                <br>
                <b style="font-size: 17px; color: #094ba6;" id="dashboard">VIEW SCHEDULES</b><br><a> </a><br>
                <a class="nav-link text-muted" href="#" style="font-size: 15px;"><span id="dashboard">Schedules</span></a><br>
        ...
        <div class="navbar navbar-expand-lg navbar-light bg-light border-bottom shadow" id="sidebar">
            <div class="d-flex flex-column px-3 min-vh-100">
                <div class="nav flex-column" id="sidebarContent">
                    ...
                    <li class="nav-item mt-3">
                        <a class="nav-link text-muted" href="Registrar-YearLevel.html"font-size: 15px;"><i class="fa-solid fa-money-check-dollar" id="icons"></i></i><span id="dashboard">Year Level</span></a>
                    </li>
                    <li class="nav-item mt-3">
                    ...
                    <li class="nav-item mt-3">
                        <a class="nav-link text-muted" href="#" style="font-size: 15px;" ><i class="fa-solid fa-monument" id="icons"></i><span id="dashboard">Schedules</span></a>
                    </li>
                    <li class="nav-item mt-3" style="margin-left: 9%">
        ...
        <div id="page-content-wrapper">
            <!-- Page content-->
            <div clas> <div class="card float-start shadow" id="CardNews">
                <div class="card-header" style="border-bottom: 2px solid #427dbe">
                    <table class="table table-borderless table-sm" style="margin-bottom:-5px">
                        <tbody>
                            <tr>
                                <td><h6 style="color: #094ba6;">POST AN ANNOUNCEMENT</h6></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                        ...
                        <div class="card-body mt-2 mb-2">
                            <div class="row">
                                <form action="#" method="POST">
                                    ...
                                    <div>
                                        <label class="form-label" for="customFile">Choose file to upload a photo</label>
                                        <input type="file" class="form-control-sm" id="customFile" />
                                    
                                    </div>
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-block bg-danger text-white mt-4" required>Post</button>
                                    </div>
                                </form>
                            </div>
                            <br>
