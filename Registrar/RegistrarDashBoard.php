...
<html>
<head>
    <title>Regitrar DashBoard</title>
        ...
        <div class="navbar navbar-expand-lg navbar-light bg-light border-bottom shadow" id="sidebar">
            <div class="d-flex flex-column px-3 min-vh-100">
                <div class="nav flex-column" id="sidebarContent">
                    ...
                    <li class="nav-item mt-3">
                        <a class="nav-link text-muted" href="Registrar-ControlPanel.htmls" style="font-size: 15px;" ><i class="fa-solid fa-monument" id="icons"></i><span id="dashboard">Semester & Period</span></a>
                    </li>
