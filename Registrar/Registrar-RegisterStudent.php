...
<html>
<head>
    <title>Regitrar Register-Student</title>
            ...
            <div class="card float-start shadow" id="CardNews">
                <div class="card-header" style="border-bottom: 2px solid #427dbe">
                    <table class="table table-borderless table-sm" style="margin-bottom:-5px">
                        <tbody>
                            <tr>
                                <td><h6 style="color: #094ba6;">REGISTER STUDENT</h6></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                            ...
                            <div class="row">
                                <form action="#" method="POST">
                                    <div class="form-floating mb-3 mt-3">
                                        <input type="text" class="form-control" id="LRN" placeholder="LRN" name="LRN">
                                        <label for="LRN">LRN/StudentID</label>
                                    </div>
                                    ...
                                    <div></div>
                                    <select class="form-select mb-3" style="width: 335px; margin-left: 3%;"  aria-label="Default select example" id="CourseDropDown">
                                        <option selected disabled>Course</option>
                                       
                                    </select>
                                   
                                    <select class="form-select mb-3" style="width: 335px; margin-left: 3%;"  aria-label="Default select example" id="YearLevelDropDown">
                                        <option selected disabled>Year Level</option>
                                       
                                    </select>
                                    <select class="form-select mb-3" style="width: 335px; margin-left: 3%;"  aria-label="Default select example" id="SectionDropDown">
