...
<html>
<head>
    <title>Regitrar Register-Year Level</title>
            ...
            <div class="card float-start shadow" id="CardNews">
                <div class="card-header" style="border-bottom: 2px solid #427dbe">
                    <table class="table table-borderless table-sm" style="margin-bottom:-5px">
                        <tbody>
                            <tr>
                                <td><h6 style="color: #094ba6;">REGISTER YEAR LEVEL</h6></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                        ...
                        <div class="card-body mt-2 mb-2">
                            <div class="row">
                                <form action="#" method="POST">
                                    <select class="form-select mb-3" name= "DeptName" style="width: 335px; margin-left: 3%;"  aria-label="Default select example" id="DepartmentDropDown">
                                    ...
                                    <select class="form-select mb-t" name="YearLevel" style="width: 335px; margin-left: 3%;" aria-label="Default select example" id="YearLevel">
                                    ...
                                    <select class="form-select mb-3 mt-3" name="SectionDropDown" style="width: 335px; margin-left: 3%;"  aria-label="Default select example" id="SectionDropDown">
                                        <option selected disabled>Section</option>
                                        <?php
                                            require 'connection.php';
                                            $query ="SELECT Section FROM tblSection";
                                            $result = $conn->query($query);
                                            if($result->num_rows> 0){
                                                while($optionData=$result->fetch_assoc()){
                                    ...
                                    <div class="col mb-3">
                                        <button type="button" class="btn" style="border: 1px solid rgb(225, 225, 225)" data-bs-toggle="modal" data-bs-target="#myModal">Define New Section</button>
                                    </div>
                                    <div class="d-grid">
                                        <button type="submit" id="submit-button" onclick="insertData()" class="btn btn-block bg-danger text-white" required>Register</button>
                                    </div>
                                    <script>
                                        ...
                                        function insertData() {
                                            ...
                                            xhttp.open("POST", "add_yearlevel.php", true);
                                            ...
                                            xhttp.send("DeptName=" + department + "&YearLevel=" + yearlevel + "&SectionDropDown=" + section);
                                        }
                                    </script>
                                </form>
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-floating">
                                                        <form action="add_section.php" method="post">
                                                            <input type="text" class="form-control" placeholder="NewSec" name="NewSec" id="NewSec">
                                                            <label for="NewSec">New Section</label>
